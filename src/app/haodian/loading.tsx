    ...
    <div style={{ minHeight: "100vh", background: "#F6F7F9" }}>
      ...
      <div style={{ padding: "16px 16px 40px" }}>
        <div style={{ maxWidth: 1240, margin: "0 auto" }}>
          <div style={{ height: 120, borderRadius: 16, background: "linear-gradient(135deg, #92400E, #F59E0B)", marginBottom: 24 }} />
            ...
            {[1,2,3,4,5,6].map(i => (
              <div key={i} style={{ background: "#fff", borderRadius: 14, overflow: "hidden", border: "1px solid #E5E7EB" }}>
                ...
                <div style={{ padding: 16 }}>
                  <div style={{ height: 18, width: "60%", background: "#E5E7EB", borderRadius: 4, marginBottom: 10 }} />
                  <div style={{ height: 14, width: "80%", background: "#F3F4F6", borderRadius: 4, marginBottom: 8 }} />
                  <div style={{ height: 20, width: "35%", background: "#FEF3C7", borderRadius: 4 }} />
                </div>
              </div>
            ))}
          </div>
