    ...
    <div style={{ minHeight: "100vh", background: "#F6F7F9" }}>
      ...
      <div style={{ padding: "16px 16px 40px" }}>
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
          <div style={{ height: 48, width: "50%", background: "#E5E7EB", borderRadius: 8, marginBottom: 24 }} />
          <div style={{ display: "flex", gap: 8, marginBottom: 24 }}>
            {[1,2,3,4,5,6].map(i => <div key={i} style={{ width: 80, height: 32, background: "#F3F4F6", borderRadius: 20 }} />)}
          </div>
          {[1,2,3,4,5].map(i => (
