    ...
    <div style={{ minHeight: "100vh", background: "#F6F7F9" }}>
      ...
      <div style={{ padding: "16px 16px 40px" }}>
        <div style={{ maxWidth: 1240, margin: "0 auto" }}>
          <div style={{ height: 120, borderRadius: 16, background: "linear-gradient(135deg, #5B21B6, #8B5CF6)", marginBottom: 24 }} />
            ...
            {[1,2,3,4].map(i => (
              <div key={i} style={{ background: "#fff", borderRadius: 14, overflow: "hidden", border: "1px solid #E5E7EB" }}>
                ...
                <div style={{ padding: 16 }}>
                  ...
                  <div style={{ height: 14, width: "55%", background: "#F3F4F6", borderRadius: 4, marginBottom: 8 }} />
