...
const TAB_LABELS: Record<string, string> = {
  ...
  "/admin/review": "全站审核",
  "/admin/users": "用户管理",
  "/admin/companies": "企业主体",
  "/admin/organizations": "组织治理",
  "/admin/orders": "订单管理",
  "/admin/mall": "自营便利店",
  "/admin/mall/orders": "便利店订单",
  "/admin/mall/products": "商品库存",
  "/admin/mall/categories": "分类网格",
  "/admin/mall/delivery": "配送骑手",
  "/admin/mall/aftersales": "售后退款",
  "/admin/reports": "违规举报",
  "/admin/risk": "风控仲裁",
  "/admin/logs": "操作日志",
  "/admin/operations": "运营看板",
  "/admin/operations/opportunities": "运营商机",
  "/admin/billing": "商业配置",
...
export function AdminLayout({
  ...
  /* ── 移动端抽屉菜单（严格对齐 9 大业务领域标准） ── */
  const drawerGroups: DrawerGroup[] = [
    {
      group: "1. 概览中心",
      icon: LayoutDashboard,
      items: [
        { label: "工作台首页", href: "/admin", icon: LayoutDashboard },
      ],
    },
    {
      group: "2. 用户与企业",
      icon: Users,
      items: [
        { label: "会员用户", href: "/admin/users", icon: Users },
        { label: "企业主体", href: "/admin/companies", icon: Briefcase },
        { label: "组织治理", href: "/admin/organizations", icon: Factory },
        { label: "人才简历", href: "/admin/resumes", icon: Users },
        { label: "角色权限", href: "/admin/profile", icon: ShieldCheck },
      ],
    },
    {
      group: "3. 内容管理",
      ...
      items: [
        ...
        { label: "内容总表", href: "/admin/content", icon: FileText },
      ],
    },
    {
      group: "4. 商城与订单",
      ...
      items: [
        ...
        { label: "便利店大盘", href: "/admin/mall", icon: ShoppingBag },
        { label: "便利店订单", href: "/admin/mall/orders", icon: PackageCheck },
        { label: "商品与库存", href: "/admin/mall/products", icon: ShoppingBag },
        { label: "分类管理", href: "/admin/mall/categories", icon: FolderOpen },
        { label: "配送与骑手", href: "/admin/mall/delivery", icon: Map },
        { label: "售后退款", href: "/admin/mall/aftersales", icon: AlertOctagon },
      ],
    },
    {
      group: "5. 审核治理",
      ...
      items: [
        ...
        { label: "风控仲裁", href: "/admin/risk", icon: AlertOctagon },
      ],
    },
    {
      group: "6. 财务中心",
      ...
      items: [
        ...
        { label: "财务对账", href: "/admin/finance", icon: FileText },
      ],
    },
    {
      group: "7. AI与自动化",
      icon: Zap,
      items: [
        { label: "AI模型用量", href: "/admin/settings/ai", icon: Zap },
        { label: "自动化工作流", href: "/admin/workflows", icon: Zap },
      ],
    },
    {
      group: "8. 运营与增长",
      ...
      items: [
        ...
        { label: "运营商机", href: "/admin/operations/opportunities", icon: BarChart3 },
        { label: "广告运营", href: "/admin/ads", icon: Megaphone },
        { label: "公众号概览", href: "/admin/wechat/overview", icon: Smartphone },
        { label: "自定义菜单", href: "/admin/wechat/menu", icon: Smartphone },
        { label: "自动回复", href: "/admin/wechat/reply", icon: Smartphone },
        { label: "微信粉丝", href: "/admin/wechat/users", icon: Smartphone },
        { label: "商业线索", href: "/admin/wechat/leads", icon: Smartphone },
        { label: "微信配置", href: "/admin/wechat/settings", icon: Settings },
        { label: "商业洞察", href: "/admin/insights", icon: BarChart3 },
      ],
    },
    {
      group: "9. 系统设置",
      ...
      items: [
        ...
        { label: "数据字典", href: "/admin/dictionaries", icon: BookOpen },
        { label: "区域网格", href: "/admin/regions", icon: Map },
        { label: "文件资源", href: "/admin/files", icon: FolderOpen },
        { label: "平台知识库", href: "/admin/knowledge", icon: BookOpen },
        { label: "服务器监控", href: "/admin/system/health", icon: Server },
        { label: "缓存治理", href: "/admin/system/cache", icon: Zap },
